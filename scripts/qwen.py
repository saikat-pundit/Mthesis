...
def main():
    ...
    print(f"🔄 Requesting analysis from qwen3.5-122b-a10b (Streaming) for {date_str}...")
    ...
    try:
        ...
        report = f"============================================================\n"
        report += f"📅 YIELD CURVE DAILY REPORT (Qwen 3.5) - {date_str}\n"
        report += f"============================================================\n\n"
...
\n"
        ...
        report_file = f"{report_dir}/qwen_report_{date_str}.txt"
